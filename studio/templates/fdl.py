...
_EXTRACTOR_SYSTEM = (
    ...
    "     5–7 phrases for any Newton / step-by-step / iterative / "
    "     proof-walkthrough prompt; 3–4 for a single-concept figure "
    "     (one tangent, one intersection); 1–2 only for a trivial "
    "     'show the curve' request.  Each phrase one short sentence; "
