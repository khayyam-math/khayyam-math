...
_GRAPHVIZ_KEYWORDS: tuple[str, ...] = (
    ...
    "recursion tree", "recursion-tree", "recurrence tree",
    "game tree", "merkle tree", "b-tree", "red-black tree",
    "subgroup lattice", "lattice of subgroups",
    "shortest path", "dijkstra", "bellman-ford",
    "spanning tree", "flow network",
